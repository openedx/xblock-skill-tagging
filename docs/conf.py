...
"""
skill_tagging documentation build configuration file.
...
project = 'skill_tagging'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'skill_tagging'
...
#
# html_title = 'skill_tagging v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Django app plugin for fetching and verifying tags for xblock skills.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'skill_tagging'),
                os.path.join(root_path, 'skill_tagging/migrations')])
